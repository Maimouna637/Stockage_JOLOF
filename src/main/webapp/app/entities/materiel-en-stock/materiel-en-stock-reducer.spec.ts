...
import reducer, {
  ...
  reset,
  updateEntity,
} from './materiel-en-stock.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIELENSTOCK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIELENSTOCK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIELENSTOCK actions', async () => {
      const arg = { id: 27681 };
    ...
    it('dispatches UPDATE_MATERIELENSTOCK actions', async () => {
      const arg = { id: 27681 };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIELENSTOCK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MATERIELENSTOCK actions', async () => {
      const arg = 42666;
