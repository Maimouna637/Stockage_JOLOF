...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './equipe.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EQUIPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EQUIPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EQUIPE actions', async () => {
      const arg = { id: 32465 };
    ...
    it('dispatches UPDATE_EQUIPE actions', async () => {
      const arg = { id: 32465 };
    ...
    it('dispatches PARTIAL_UPDATE_EQUIPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EQUIPE actions', async () => {
      const arg = 42666;
