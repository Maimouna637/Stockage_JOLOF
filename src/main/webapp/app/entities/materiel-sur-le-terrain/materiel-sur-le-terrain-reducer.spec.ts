...
import reducer, {
  ...
  reset,
  updateEntity,
} from './materiel-sur-le-terrain.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIELSURLETERRAIN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MATERIELSURLETERRAIN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MATERIELSURLETERRAIN actions', async () => {
      const arg = { id: 31033 };
    ...
    it('dispatches UPDATE_MATERIELSURLETERRAIN actions', async () => {
      const arg = { id: 31033 };
    ...
    it('dispatches PARTIAL_UPDATE_MATERIELSURLETERRAIN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MATERIELSURLETERRAIN actions', async () => {
      const arg = 42666;
